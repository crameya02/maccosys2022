...
Public Class frmChartofAccountsV2
    ...
    Private Sub btnimport_Click(sender As Object, e As EventArgs) Handles btnImport.Click
            ...
            Dim headerRow As String() = TextFieldParser1.ReadFields()

            If COADGV.Columns.Count = 0 AndAlso headerRow.Count > 0 Then
                For i As Integer = 0 To headerRow.Count - 1
                    ' Use the first line as the column names
                    COADGV.Columns.Add(headerRow(i), headerRow(i))
                Next
            End If
    ...
    Private Sub COADGV_MouseClick(sender As Object, e As MouseEventArgs)
        Try
            If COADGV.Rows.Count > 0 Then
